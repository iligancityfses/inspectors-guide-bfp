...
export default function ToolsPage() {
  return (
    <div className="container mx-auto px-4 py-8 bg-white dark:bg-gray-900">
      <h1 className="text-3xl font-bold mb-8 text-center text-red-700 dark:text-red-400">Fire Safety Inspector Tools</h1>
      
      <div className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-red-600 dark:text-red-400">Fire Safety Calculators</h2>
      ...
      <div className="mb-12">
        <h2 className="text-2xl font-bold mb-4 text-red-600 dark:text-red-400">Fire Safety Reference Library</h2>
        <p className="text-gray-600 dark:text-gray-300 mb-6">
